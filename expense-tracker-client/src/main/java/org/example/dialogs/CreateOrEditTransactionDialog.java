        ...
        saveButton.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent mouseEvent) {
                ...
                if(transactionCategoryName != null){
                    TransactionCategory transactionCategory = Utility.findTransactionCategoryByName(
                ...
                if(!isEditing ? SqlUtil.postTransaction(transactionDataObject)
                    ...
                    Utility.showAlertDialog(Alert.AlertType.INFORMATION,
                    ...
                    Utility.showAlertDialog(Alert.AlertType.ERROR,
